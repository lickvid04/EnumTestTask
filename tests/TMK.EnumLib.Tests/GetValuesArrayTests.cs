...
public class GetValuesArrayTests
{
    ...
    public void GetValuesArray_InvalidDays(Days day, int[] expected)
    {
        int[] actual = day.GetArrayValues();
    ...
    public void GetValuesArray_ValidSystems(SubSystemType system, int[] expected)
    {
    ...
    public void GetValuesArray_InvalidSystems(SubSystemType system, int[] expected)
    {
        int[] actual = system.GetArrayValues();
        Assert.NotEqual(expected, actual);
    }
